...
Route::group(['middleware'=>['auth']], function (){
    ...
    Route::any('employees',[EmployeeController::class,'account-index'])->name('account');
    ...
    Route::any('apply-leave',[EmployeeLeaveController::class,'create'])->name('apply-leave');

    Route::any('leave-listing',[EmployeeLeaveController::class,'listing'])->name('leave-listing');
