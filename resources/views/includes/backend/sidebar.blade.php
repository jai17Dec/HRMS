...
<div class="sidebar" id="sidebar">
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                <li class="menu-title">
                    <span style="color: #0dcaf0;">Main</span>
                </li>
                ...
                <li class="menu-title">
                    <span style="color: #0dcaf0;">Employees</span>
                </li>
                <li class="submenu">
...
<li><a class="{{ route_is('apply-leave') ? 'active' : '' }}" href="{{route('apply-leave')}}">Apply Leave</a></li>
<li><a class="{{ route_is('leave-listing') ? 'active' : '' }}" href="{{route('leave-listing')}}">Leave Listing</a></li>
                ...
                <li class="menu-title">
                    <span style="color: #0dcaf0;">HR</span>
                </li>
                <li class="submenu">
