...
<div class="row align-items-center">
	<div class="col">
		<h3 class="page-title">Leave Listing</h3>
		<ul class="breadcrumb">
			<li class="breadcrumb-item"><a href="{{route('dashboard')}}">Dashboard</a></li>
			<li class="breadcrumb-item active">Leave Listing</li>
		</ul>
	</div>
			...
			<div class="modal-body">
				<form method="POST" action="{{route('employee-leave')}}">
					...
					<div class="form-group">
						...
						<div class="icon">
						    <input type="datetime-local" value="2023-06-01T00:00" class="form-control"/>
						</div>
					</div>
					<div class="form-group">
