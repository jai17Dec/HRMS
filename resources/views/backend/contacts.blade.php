...
<td>{{$contact->status}}</td>
 ...
 <div class="dropdown dropdown-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a data-id="{{$contact->id}}" data-name="{{$contact->name}}" class="dropdown-item editbtn" href="javascript:void(0);" data-toggle="modal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
    ...
    <script>
        $(document).ready(function(){
            var table = $('#datatable').DataTable({
                ...
                <script>            $('.editbtn').on('click',function(){
